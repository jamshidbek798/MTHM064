...
logcounts = pd.read_csv("Data/Dataset 2 — Perturb-seq/CRISPRi_whole_upr_logcounts.csv")

# Load sample metadata (gRNA, target gene, etc.)
meta_data = pd.read_csv("Data/Dataset 2 — Perturb-seq/meta_CRISPRi_whole.csv")
